...
layout: base.njk
title: Programs
description: "Integritas Civica's programs: bridge-building media, cross-ideological dialogue, evidence-based advocacy, and community engagement."
---

# Programs

<blockquote class="epigraph">
<p>"Fighting a war is easy. Destroying is easy. Building a new world out of what's left of the old, that is what's hard. But that is your strength."</p>
<cite>Delenn, <em>Babylon 5</em></cite>
</blockquote>
...
Public R&D investment delivers 140-210% gross social returns ([Fieldhouse & Mertens, NBER 2024](https://www.nber.org/books-and-chapters/entrepreneurship-and-innovation-policy-and-economy-volume-5/social-returns-public-rd)) — well above what private investors are able to capture, which is why public funding fills a gap the market systematically leaves open. The Human Genome Project returned roughly $66 for every dollar invested (Battelle 2013 update). GPS, originally military research, has generated an estimated $1.4 trillion in cumulative civilian economic value (in 2017 dollars). These aren't opinions. They're data.
...
We support local bridge-building efforts and connect them to a broader network of people committed to honest understanding across differences.

Our approach follows the principle of subsidiarity: local communities lead their own conversations, while we provide frameworks, media, and connections that amplify what works.
